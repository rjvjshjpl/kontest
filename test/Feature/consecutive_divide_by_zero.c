...
// RUN: %klee --output-dir=%t.klee-out -check-div-zero -emit-all-errors=0 -optimize=false  %t.bc 2> %t.log
...
// RUN: grep "consecutive_divide_by_zero.c:31: divide by zero" %t.log
