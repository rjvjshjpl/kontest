...
// These need to be accessible from main so they can be enabled if needed
cl::opt<bool>
...
void StatsTracker::writeStatsLine() {
  *statsFile << "(" << stats::instructions
             ...
             << "," << stats::concreteTime / 1000000.
             << "," << stats::symbolicTime / 1000000.
#ifdef DEBUG
...
void StatsTracker::writeIStats() {
  ...
  istatsMask |= 1<<sm.getStatisticID("Divergences");
