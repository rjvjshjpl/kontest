...
public:
  ...
  virtual void processTestCase(const ExecutionState &state,
                               ...
                               const char *suffix,
                               unsigned testID,
                               bool suppressExitOnError = false) = 0;

  virtual bool needsSymbolicExecution() const = 0;
};
...
public:
  ...
  virtual KTest *getSymbolicSolution(const ExecutionState &state, unsigned testID, bool &ranSymbolically) = 0;
