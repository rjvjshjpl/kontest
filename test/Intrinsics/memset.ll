...
entry:
  ...
  %v = load i32* %s, align 4
  %r = icmp eq i32 %v, 16843009
  br i1 %r, label %bbtrue, label %bbfalse

bbtrue:
  %res = call i32 @puts(i8* getelementptr inbounds ([5 x i8]* @.passstr, i64 0, i64 0)) nounwind
  ret i32 0

bbfalse:
  %res2 = call i32 @puts(i8* getelementptr inbounds ([5 x i8]* @.failstr, i64 0, i64 0)) nounwind
  ret i32 0
}
