...
// RUN: %klee --output-dir=%t.klee-out --libc=klee %t.bc
...
// CHECK: KLEE_RUN_TEST_ERROR: invalid klee_make_symbolic_range(0,2,x) value, got: 20
// CHECK: KLEE_RUN_TEST_ERROR: Forcing execution to continue
// CHECK: x=20

// CHECK_FATAL: KLEE_RUN_TEST_ERROR: invalid klee_make_symbolic_range(0,2,x) value, got: 20
