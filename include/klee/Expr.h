...
public:
  ...
  static const ref<ConstantExpr> True;
  static const ref<ConstantExpr> False;
  static const ref<ConstantExpr> Int32_0;
  static const ref<ConstantExpr> Int32_1;
  static const ref<ConstantExpr> Int32_2;
  static const ref<ConstantExpr> Int32_3;
  static const ref<ConstantExpr> Int32_4;
  static const ref<ConstantExpr> Int32_5;
  static const ref<ConstantExpr> Int32_6;
  static const ref<ConstantExpr> Int32_7;
...
namespace std
{
  // hash function for Expr
  template<>
  struct hash< klee::Expr >
  {
    std::size_t operator()(const klee::Expr &e) const {
      return e.hash();
    }
  };
}
